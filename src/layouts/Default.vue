...
const viteHostnameChattyBe = import.meta.env.VITE_HOSTNAME_CHATTY_BE;
...
const botLanding = {
  ...
  faq: [
    {
      'name': 'Fa male? 😌',
      'value': 'L\'agopuntura è dolorosa?'
    },
    {
      'name': 'Quante sedute servono? ⏳',
      'value': 'Di quante sedute ho bisogno per vedere risultati?'
    },
    {
      'name': 'È sicura? 🌿',
