...
.custom-appbar {
  ...
  background: linear-gradient(118deg, #f8d4d9 0%, #f8d4d9 40%, #7d2636 44%, #7d2636 100%) !important;
...
@media screen and (max-width: 599px) {
  .custom-appbar {
    background: linear-gradient(240deg, #f8d4d9 0%, #f8d4d9 72%, #7d2636 78%, #7d2636 100%) !important;
  }
}
</style>
