<template>
    <v-container class="dioassissi">
        ...
        <v-slide-group show-arrows>
            <template #prev>
            <v-icon class="arrow-button">mdi-chevron-left</v-icon>
            </template>
            <template #next>
            <v-icon class="arrow-button">mdi-chevron-right</v-icon>
            </template>
    
            <v-slide-group-item v-for="review in reviews" :key="review.name">
            <v-card :width="cardWidth" class="cards" style="border-radius: 12px;">
